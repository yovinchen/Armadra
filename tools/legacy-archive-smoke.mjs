...
names=['0001_initial.sql','0002_agent_mailbox.sql','0003_retire_kanban.sql','0004_agent_handoffs.sql','0005_browser_sessions.sql','0006_agent_prompt_deliveries.sql','0007_handoff_attempts.sql','0008_write_ownership.sql','0009_workspace_execution_host.sql','0012_browser_process.sql']
def apply(number):
