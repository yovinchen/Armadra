...
画布使用 tldraw，终端使用 xterm.js，编辑器使用 CodeMirror；UI 使用 shadcn/ui 与 Tailwind。
...
| 目录                          | 职责                                 |
| ----------------------------- | ------------------------------------ |
| `src/canvas`、`src/nodes`     | tldraw shape / binding、节点与覆盖层 |
...
| `src/i18n`、`src/platform`    | 双语文案、Tauri / 浏览器适配         |
