...
export const modals: MessageModule = {
  "zh-CN": {
    ...
    "settings.priceSource.network": "models.dev",
    "settings.priceSource.cache": "models.dev（本地缓存）",
    "settings.priceSource.builtIn": "随版本发布的内置表",
    "settings.priceUpdated": "更新时间",
    "settings.priceUpdatedNever": "尚未取到",
    "settings.priceModelCount": "{count} 个模型有报价",
    "settings.priceRefresh": "更新目录",
    "settings.priceRefreshFailed": "更新失败，仍在用现有目录。",
    ...
    "settings.whiteboard.wrap": "整体框住才选中",
    ...
    "settings.shortcut.more": "「{command}」的更多操作",
    "settings.shortcut.add": "再添加一组按键",
    "settings.shortcut.removeOne": "移除 {keys}",
    "settings.shortcut.clear": "设为无",
    "settings.shortcut.when": "条件",
    "settings.shortcut.when.edit": "编辑条件…",
    "settings.shortcut.when.title": "「{command}」的条件",
    "settings.shortcut.when.syntax": "条件写得不对，无法解析。",
    "settings.shortcut.when.unknown": "不认识的键：{keys}。可用的键：{known}",
    "settings.shortcut.when.reset": "恢复默认条件",
    "settings.shortcut.when.save": "保存",
  ...
  en: {
    ...
    "settings.priceSource.network": "models.dev",
    "settings.priceSource.cache": "models.dev (cached locally)",
    "settings.priceSource.builtIn": "Built into this release",
    "settings.priceUpdated": "Updated",
    "settings.priceUpdatedNever": "Never fetched",
    "settings.priceModelCount": "{count} models priced",
    "settings.priceRefresh": "Update catalog",
    "settings.priceRefreshFailed":
      "Update failed; the current catalog is still in use.",
    ...
    "settings.whiteboard.wrap": "Select fully enclosed",
    ...
    "settings.shortcut.more": "More actions for “{command}”",
    "settings.shortcut.add": "Add another key",
    "settings.shortcut.removeOne": "Remove {keys}",
    "settings.shortcut.clear": "Set to none",
    "settings.shortcut.when": "Condition",
    "settings.shortcut.when.edit": "Edit condition…",
    "settings.shortcut.when.title": "Condition for “{command}”",
    "settings.shortcut.when.syntax": "This condition could not be parsed.",
    "settings.shortcut.when.unknown":
      "Unknown keys: {keys}. Available keys: {known}",
    "settings.shortcut.when.reset": "Restore default condition",
    "settings.shortcut.when.save": "Save",
