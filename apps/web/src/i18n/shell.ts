...
export const shell: MessageModule = {
  "zh-CN": {
    ...
    "sidebar.newBoard": "新建画布",
    "sidebar.boardDefaultName": "画布 {index}",
    "sidebar.pinned": "置顶",
    "sidebar.pin": "置顶",
    "sidebar.unpin": "取消置顶",
    "sidebar.projects": "项目",
    ...
    "sidebar.unread": "未读",
    "sidebar.boardName": "画布名称",
    "sidebar.boardMenu": "画布操作",
  ...
  en: {
    ...
    "dock.zoom": "Zoom",
    "dock.zoomFit": "Fit",
    "dock.zoomFitHint": "Fit view · right-click for levels",
