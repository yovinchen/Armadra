...
export const editorMerge: MessageModule = {
  "zh-CN": {
    "merge.open": "三方合并",
    "merge.title": "解决冲突",
    "merge.draft.title": "合并磁盘上的修改",
    "merge.draft.apply": "应用到草稿",
    "merge.draft.noConflicts": "两边的改动没有互相冲突，直接应用即可",
    "merge.draft.base": "打开时的版本",
    "merge.draft.ours": "草稿",
    "merge.draft.theirs": "磁盘上的版本",
    "merge.draft.choice.ours": "取草稿",
    "merge.draft.choice.theirs": "取磁盘版",
  ...
  en: {
    ...
    "merge.draft.title": "Merge changes on disk",
    "merge.draft.apply": "Apply to draft",
    "merge.draft.noConflicts": "The two sides do not conflict; apply as is",
    "merge.draft.base": "Version when opened",
    "merge.draft.ours": "Draft",
    "merge.draft.theirs": "Version on disk",
    "merge.draft.choice.ours": "Take draft",
    "merge.draft.choice.theirs": "Take disk",
