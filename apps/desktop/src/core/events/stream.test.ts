...
describe("WorkspaceEventStream", () => {
  ...
  it("carries the 21 contractual type strings, plus node.created, and no others", () => {
    expect(WORKSPACE_EVENT_TYPES).toHaveLength(22);
    expect(new Set(WORKSPACE_EVENT_TYPES).size).toBe(22);
