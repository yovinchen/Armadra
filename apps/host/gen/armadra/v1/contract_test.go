...
func cases() map[string]proto.Message {
	return map[string]proto.Message{
		...
		// The desktop shell's native transport carries bearer credentials in
		// the body (docs/design/host-native-session.md §3); a browser response
		// leaves `native` unset.
		"identity_native_session": &pb.AuthenticatedSession{HostId: "host-1", Device: &pb.DeviceIdentity{DeviceId: "device-2", PrincipalId: "owner-1", DisplayName: "本机桌面", Role: "owner", CreatedAtUnixMs: 1788557000000, Revision: 1}, CsrfToken: "fixture-not-a-secret", Scopes: []*pb.AuthorizationGrant{{Permission: "identity:read"}}, ExpiresAtUnixMs: 1788557900000, Native: &pb.NativeSessionCredentials{AccessToken: "fixture-access-not-a-secret", RefreshToken: "fixture-refresh-not-a-secret"}},
