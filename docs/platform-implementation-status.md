...
| M4 | 进行中 | Git 分支/同步/历史/worktree基础已落地；hunk、AI提交信息、分组与其他进阶流程继续 |
...
| G02 | 分支管理、fetch/ff-only pull/non-force push、操作队列、稳定历史分页和父关系图已实现 | 操作重载恢复、进阶 merge/rebase/cherry-pick/stash 与冲突继续/中止 |
